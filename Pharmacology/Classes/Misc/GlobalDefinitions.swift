...
final class GlobalDefinitions {
    ...
    static let apiKey = "rrNUmVKIcAKrO1bX"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "n8TTjpNmir5VcPfX"

    static let applicationTag = "EXAM_PHARMACOLOGY"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/pharmacology-for-nurses/id1591622787"
    static let appleAppID = "1591622787"
